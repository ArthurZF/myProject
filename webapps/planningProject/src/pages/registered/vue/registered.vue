<template>
  <div class="outs" :style="{backgroundImage: 'url(' +bg + ')'}">
    <div class="registered-table">
      <el-form :model="registeredData" ref="registeredData" label-width="120px" label-suffix="：" hide-required-asterisk
        status-icon label-position="left" class="form-box" :rules="registeredDataRules">
        <el-form-item label="账号" prop="account">
          <el-input v-model.trim="registeredData.account" clearable autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="密码" prop="passWord">
          <el-input v-model.trim="registeredData.passWord" show-password autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="再次确认密码" prop="surePassWorld">
          <el-input v-model.trim="registeredData.surePassWorld" show-password autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="姓" prop="userFirstName">
          <el-input v-model.trim="registeredData.userFirstName" clearable autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="名" prop="userLastName">
          <el-input v-model.trim="registeredData.userLastName" clearable autocomplete="off"></el-input>
        </el-form-item>
        ...
        <el-form-item label="手机" prop="phone">
          <el-input v-model.trim="registeredData.phone" clearable type="tel" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      registeredSuccess() {
        this.$alert('申请已提交，申请结果将以短信方式发送到您填写手机号上', '提交成功', {
...
<style lang="less" scoped>
  .outs {
    ...
    .registered-table {
      ...
      top: 60px;
      border-radius: 8px;
      background-image: linear-gradient(-180deg, rgba(255, 255, 255, .3), rgba(244, 244, 244, .8));
