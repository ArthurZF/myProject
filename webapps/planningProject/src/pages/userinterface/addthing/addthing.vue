<template>
  <div class="outs">
    ...
    <div class="flex">
      <el-menu default-active="1" background-color="#545c64" text-color="#fff" active-text-color="#ffd04b" class="menu-outs" @select="menuSelect">
        <el-menu-item index="1">周期性</el-menu-item>
        <el-menu-item index="2">非周期性</el-menu-item>
      </el-menu>
